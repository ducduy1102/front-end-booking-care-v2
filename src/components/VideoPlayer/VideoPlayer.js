...
import { togglePiP } from "../../store/actions";
...
const VideoPlayer = ({
  ...
  const handleExpandPlayer = () => {
    // onExpandPlayer(); // Gọi hàm phóng to từ About
    history.push("/home");
    // if (onExpandPlayer) onExpandPlayer();
    dispatch(togglePiP()); // Thu nhỏ video
  };
  ...
  return (
    ...
    >
      ...
      ></iframe>
      <button
        onClick={isPiP ? handleExpandPlayer : () => dispatch(togglePiP())}
        // onClick={isPiP ? handleExpandPlayer : onExpandPlayer}
        style={{
          position: "absolute",
          top: isPiP ? "5px" : "",
          bottom: isPiP ? "" : "2.2%",
